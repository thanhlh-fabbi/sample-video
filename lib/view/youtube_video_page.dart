...
class YoutubeVideoPage extends StatefulWidget {
  ...
  final dynamic listVideo;
  const YoutubeVideoPage({Key? key, required this.videoID, this.listVideo})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return YoutubePlayerBuilder(
      ...
      player: YoutubePlayer(
        ...
        onEnded: (data) {
          _controller.load(widget.listVideo[
              (widget.listVideo.indexOf(data.videoId) + 1) %
                  widget.listVideo.length]);
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: _isPlayerReady
                            ? () => _controller.load(widget.listVideo[(widget
                                        .listVideo
